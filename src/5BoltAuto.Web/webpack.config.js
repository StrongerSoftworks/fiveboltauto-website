...
module.exports = [
  // Vendor JS
  {
    ...
    plugins: [
      new HtmlWebpackPlugin({
        ...
        filename: path.join(
          __dirname,
          "./Components/Webpack/VendorScripts.razor"
        ),
        hash: true,
        minify: !isDebugMode,
        templateParameters: (compilation, assets) => {
          const scripts = assets.js
            .map(
              (filePath) =>
                `<script src="/bundle/vendor/js${filePath}"></script>`
            )
            .join("\n");
          return { scripts };
        },
  ...
  // Vendor CSS
  {
    ...
    plugins: [
      new HtmlWebpackPlugin({
        ...
        filename: path.join(
          __dirname,
          "./Components/Webpack/VendorStylesSheets.razor"
        ),
        hash: true,
        minify: !isDebugMode,
        templateParameters: (compilation, assets) => {
          const styleSheets = assets.css
            .map(
              (filePath) =>
                `<link rel="stylesheet" href="/bundle/vendor/css${filePath}" />`
            )
            .join("\n");
          return { styleSheets };
        },
      ...
      isDebugMode
        ...
        : new PurgeCSSPlugin({
            paths: glob.sync(
              `${path.join(__dirname, "../")}/**/*.{razor,cs,js}`,
  ...
  // JS
  {
    mode: isDebugMode ? "development" : "production",
    entry: {
      bootstrap: "./assets/js/bootstrap-custom.js",
    ...
    plugins: [
      new HtmlWebpackPlugin({
        ...
        templateParameters: (compilation, assets) => {
          const scripts = assets.js
            .map((filePath) => `<script src="/bundle/js${filePath}"></script>`)
            .join("\n");
          return { scripts };
        },
      }),
  ...
  // CSS
  {
    ...
    mode: isDebugMode ? "development" : "production",
    entry: {
      bootstrap: "./assets/scss/bootstrap-custom.scss",
    ...
    plugins: [
      new HtmlWebpackPlugin({
        ...
        filename: path.join(
          __dirname,
          "./Components/Webpack/StylesSheets.razor"
        ),
        hash: true,
        minify: !isDebugMode,
        templateParameters: (compilation, assets) => {
          const styleSheets = assets.css
            .map(
              (filePath) =>
                `<link rel="stylesheet" href="/bundle/css${filePath}" />`
            )
            .join("\n");
          return { styleSheets };
        },
